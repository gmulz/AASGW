<?php
/**
 * AASGW functions and definitions
 *
 * @package AASGW
 */
 ...
 */
function aasgw_setup() {

	/*
	 * Make theme available for translation.
	 * Translations can be filed in the /languages/ directory.
	 * If you're building a theme based on AASGW, use a find and replace
	 * to change 'aasgw' to the name of your theme in all the template files
	 */
	load_theme_textdomain( 'aasgw', get_template_directory() . '/languages' );
 ...
 */
function aasgw_widgets_init() {
	register_sidebar( array(
		'name'          => __( 'Sidebar', 'aasgw' ),
		'id'            => 'sidebar-1',
		'description'   => '',
...
add_action( 'widgets_init', 'aasgw_widgets_init' );
...
add_action( 'wp_enqueue_scripts', 'aasgw_scripts' );
